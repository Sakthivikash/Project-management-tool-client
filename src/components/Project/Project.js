...
export function Project() {
  ...
  const getProject = () => {
    fetch(`https://project-management-tool-server.vercel.app/projects/${id}`, {
      method: "GET",
    })
      .then((data) => data.json())
  ...
  const getTasksToDo = () => {
    fetch(
      `https://project-management-tool-server.vercel.app/tasks/to-do/${id}`,
      { method: "GET" }
    )
      .then((data) => data.json())
  ...
  const getTasksInProg = () => {
    fetch(
      `https://project-management-tool-server.vercel.app/tasks/in-prograss/${id}`,
      { method: "GET" }
    )
      .then((data) => data.json())
  ...
  const getTasksDone = () => {
    fetch(
      `https://project-management-tool-server.vercel.app/tasks/done/${id}`,
      { method: "GET" }
    )
      .then((data) => data.json())
  ...
  async function sendRequest(newTask) {
    ...
    const res = await axios
      .post(
        `https://project-management-tool-server.vercel.app/tasks/create-task/${id}`,
        newTask
      )
      .catch((err) => {
                ...
                <div
                  ...
                  onClick={async () => {
                    const deleteProject = await axios
                      .delete(
                        `https://project-management-tool-server.vercel.app/projects/del/${data._id}`
                      )
                      .catch((err) => {
                        alert(err.response.data.message);
                      });
                              ...
                              >
                                <MenuItem
                                  onClick={async () => {
                                    const res = await axios
                                      .put(
                                        `https://project-management-tool-server.vercel.app/tasks/update-task/${data._id}`,
                                        {
                                          task: data.task,
                                          prograss: "To-Do",
                                        }
                            ...
                            <Button
                              ...
                              onClick={async () => {
                                const deleteTask = await axios
                                  .delete(
                                    `https://project-management-tool-server.vercel.app/tasks/del/${data._id}`
                                  )
                                  .catch((err) => {
                                    alert(err.response.data.message);
                                  });
